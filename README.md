...
[![](https://jitpack.io/v/hantrungkien/BottomSheetBehavior.svg)](https://jitpack.io/#hantrungkien/BottomSheetBehavior)
...
module/build.gradle
````gradle
implementation 'com.github.hantrungkien:BottomSheetBehavior:v1.0.0'
````
